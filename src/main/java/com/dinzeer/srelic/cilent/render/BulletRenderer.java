...
@OnlyIn(Dist.CLIENT)
public class BulletRenderer<T extends BigDriveEnity> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Srelic.prefix("model/util/big_drive.png");
    private static final ResourceLocation MODEL = Srelic.prefix("model/util/bullet.obj");
