...
import com.dinzeer.srelic.entity.NeoDriveEnity;
...
@OnlyIn(Dist.CLIENT)
public class NeoRenderer<T extends NeoDriveEnity> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Srelic.prefix("model/util/big_drive.png");
    private static final ResourceLocation MODEL = Srelic.prefix("model/util/utr_drive.obj");
    ...
    public NeoRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
