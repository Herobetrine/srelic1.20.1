...
import static com.dinzeer.srelic.Srelic.id;
...
public class BlackHoleRenderer extends EntityRenderer<BlackHole> {
    ...
    private static final ResourceLocation CENTER_TEXTURE = id("textures/entity/black_hole/black_hole.png");
    private static final ResourceLocation BEAM_TEXTURE = id("textures/entity/black_hole/beam.png");
...
//            vertex2(vertexConsumer, matrix, size1, size2);
    ...
    public ResourceLocation getTextureLocation(BlackHole pEntity) {
        return id("textures/entity/icicle_projectile.png");
    }
