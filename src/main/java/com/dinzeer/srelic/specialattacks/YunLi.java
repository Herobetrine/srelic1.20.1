...
public class YunLi {
    ...
    public static void atHurt(LivingHurtEvent event) {
        ...
        if (entity1 instanceof Player player){
            if (player.getPersistentData().getInt("yunliP") > 0){
                ...
                if (event.getSource().getEntity()!=null){
                    ...
                    if (entity instanceof LivingEntity livingEntity){
                        ...
                        Vec3 farthestAirBlockAbove = getFarthestAirBlockAbove(livingEntity, 6);
                        player.teleportTo(farthestAirBlockAbove.x, farthestAirBlockAbove.y, farthestAirBlockAbove.z);
            ...
            for (int i = 0; i < count; i++) {
                YunLiEntity ss = new YunLiEntity(SREntiteRegristrys.YunLi, worldIn);
                ...
                ss.setRoll(0);
                ss.setDamage(GetNumUtil.getdamage(player)*0.3+2);
                // force riding
