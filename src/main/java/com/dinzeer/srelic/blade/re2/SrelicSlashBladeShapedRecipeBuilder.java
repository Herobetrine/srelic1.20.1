...
public class SrelicSlashBladeShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public SrelicSlashBladeShapedRecipeBuilder(ItemLike item, int count) {
        this.result = item.asItem();
        this.count = count;
    }
    public static SrelicSlashBladeShapedRecipeBuilder shaped(ResourceLocation blade) {
        return shaped(SRItem.getItem(SRItem.SRELIC_BLADE_ID), 1).blade(blade);
    }

    public static SrelicSlashBladeShapedRecipeBuilder shaped(ItemLike result) {
        return shaped(result, 1);
    }

    public static SrelicSlashBladeShapedRecipeBuilder shaped(ItemLike result, int count) {
        return new SrelicSlashBladeShapedRecipeBuilder(result, count);
    }

    public SrelicSlashBladeShapedRecipeBuilder define(Character key, TagKey<Item> tag) {
        return this.define(key, Ingredient.of(tag));
    }

    public SrelicSlashBladeShapedRecipeBuilder define(Character key, ItemLike tag) {
        return this.define(key, Ingredient.of(tag));
    }

    public SrelicSlashBladeShapedRecipeBuilder blade(ResourceLocation blade) {
        this.blade = blade;
        return this;
    }

    public SrelicSlashBladeShapedRecipeBuilder define(Character key, Ingredient ingredient) {
    ...
    public SrelicSlashBladeShapedRecipeBuilder pattern(String pattern) {
    ...
    public SrelicSlashBladeShapedRecipeBuilder unlockedBy(String key, CriterionTriggerInstance trigger) {
        this.advancement.addCriterion(key, trigger);
        return this;
    }

    public SrelicSlashBladeShapedRecipeBuilder group(@Nullable String group) {
        this.group = group;
        return this;
    }

    public SrelicSlashBladeShapedRecipeBuilder showNotification(boolean show) {
    ...
    public static class Result extends CraftingResult {
        ...
        public RecipeSerializer<?> getType() {
            return SrelicSlashBladeShapedRecipe.SERIALIZER;
        }
