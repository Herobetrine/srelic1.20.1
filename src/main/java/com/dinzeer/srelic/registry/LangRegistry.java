...
import com.dinzeer.srelic.data.SRelicBuiltlnRegsitryHF;
...
public class LangRegistry {
    public static void register() {
        ...
        REGISTRATE.addRawLang(CreateItemLang(SRelicBuiltlnRegsitryHF.samu_hf), "能量化·火萤五型「向死而生」");
        REGISTRATE.addRawLang(CreateItemLang(SRelicBuiltlnRegsitryHF.FIRE_HF), "能量化·天火圣裁「破坏之键」");
        REGISTRATE.addRawLang(CreateItemLang(SRelicBuiltlnRegsitryHF.RED_QUEEN_HF), "能量化·绯红女王「demon trigger」");
...
// 炽焰过载
        ...
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc", "§c每次普攻命中叠加一层「红椿·蕊」");
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc_1", "§4每层红椿·蕊增加1.5%造成的伤害");
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc_2", "§c满层后清空红椿·蕊的所有层数并获得一层含苞印记");
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc_3", "§c含苞存在期间不会叠加红椿·蕊");
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc_4", "§c含苞存在10秒,含苞持续期间你造成的伤害增加180%");
