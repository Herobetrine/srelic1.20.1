...
public class BulletEntityGrass extends BigDriveEnity {
    public BulletEntityGrass(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (targetEntity instanceof LivingEntity lv) {
            lv.addEffect(new MobEffectInstance(MobEffects.POISON,60,1));
        }
