...
public class NeoDriveEnity extends EntityAbstractSummonedSword {
    ...
    public NeoDriveEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
    ...
    public static NeoDriveEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn) {
        return new NeoDriveEnity(SREntiteRegristrys.NeoDrive, worldIn);
    }
    ...
    static {
        COLOR = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.INT);
        FLAGS = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.INT);
        RANK = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.FLOAT);
        ROTATION_OFFSET = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.FLOAT);
        ROTATION_ROLL = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.FLOAT);
        BASESIZE = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.FLOAT);
        SPEED = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.FLOAT);
        LIFETIME = SynchedEntityData.defineId(NeoDriveEnity.class, EntityDataSerializers.FLOAT);
    }
}
